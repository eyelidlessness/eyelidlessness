...
- **[@getodk/xforms-engine](https://github.com/getodk/web-forms/tree/ab3be86e457250f4bbb58ff9857695a9f9d1c789/packages/xforms-engine)** (Oct 2023 – Apr 2025)
  
  Client-agnostic, reactive runtime for
  [ODK XForms](https://getodk.github.io/xforms-spec/).
- **[@getodk/xpath](https://github.com/getodk/web-forms/tree/ab3be86e457250f4bbb58ff9857695a9f9d1c789/packages/xpath)** (Oct 2023 – Apr 2025)
...
- **[@getodk/tree-sitter-xpath](https://github.com/getodk/web-forms/tree/ab3be86e457250f4bbb58ff9857695a9f9d1c789/packages/tree-sitter-xpath)** (Oct 2023 – Apr 2025)
  
  [tree-sitter](https://tree-sitter.github.io/tree-sitter/) parser for
  XPath 1.0 syntax.
- **[HNDarkMode](https://github.com/eyelidlessness/HNDarkMode)** (Jan 2021 – Jan 2021)
...
- **[cljs-rrule](https://github.com/reup-distribution/cljs-rrule)** (Jun 2016 – Jul 2016)
...
- **[cljs-rest](https://github.com/reup-distribution/cljs-rest)** (Mar 2016 – Jul 2016)
...
- **[alter-cljs](https://github.com/eyelidlessness/alter-cljs)** (Jan 2016 – Jan 2016)
...
- **[GitHub Issues Dump](https://github.com/ClipCard/github_issues_dump)** (Aug 2015 – Aug 2015)
...
- **[Bundle Tracker](https://github.com/ClipCard/bundle_tracker)** (Jan 2015 – May 2015)
...
- **[Astro](https://github.com/snowpackjs/astro)** (Jul 2021 – Jul 2021)
  
  Collaborate with core contributors to add support for rendering
  [SolidJS](https://www.solidjs.com/) components.
- **[Microsite](https://github.com/natemoo-re/microsite)** (Jan 2021 – May 2021)
  
  Several bug fixes and feature enhancements.
- **[typescript-eslint](https://github.com/typescript-eslint/typescript-eslint)** (Oct 2020 – Oct 2020)
...
- **[mdx](https://github.com/mdx-js/mdx)** (Feb 2020 – Feb 2020)
  
  Improved TypeScript support.
- **[FAST](https://github.com/microsoft/fast)** (Aug 2018 – Aug 2018)
  
  Improved documentation.
- **[Razzle](https://github.com/jaredpalmer/razzle)** (Aug 2017 – Aug 2017)
...
- **[pre-commit-mypy](https://github.com/d1ff/pre-commit-mypy)** (Oct 2016 – Oct 2016)
  
  Expanded version support.
- **[speclj](https://github.com/slagyr/speclj)** (Apr 2016 – Apr 2016)
...
- **[Figwheel](https://github.com/bhauman/lein-figwheel)** (Dec 2015 – Dec 2015)
  
  Added support for the `:notify-command` configuration allowing
  projects to run arbitrary commands once a rebuild is complete.
- **[quick-clojure](https://github.com/benwbooth/quick-clojure)** (Jan 2015 – Jan 2015)
